...
public class ScreenManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("进入start" );
        boundary = GameObject.Find("/Border");
        if (boundary == null)
    ...
    private bool 是否暂停=false;

    //public void OnEnable()
    //{

    //    //We cache the Hash to the "Open" Parameter, so we can feed to Animator.SetBool.
    //    Open = Animator.StringToHash(k_OpenTransitionName);
    ...
    {
        Time.timeScale = 0;
        Debug.Log("enter1 openpanel" );
       // if (m_Open == anim)
      //      return;
        Debug.Log("enter2 openpanel");
